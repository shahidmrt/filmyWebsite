...
import { Castpicture,opt, ReviewList, opt1, writers,producer,Mvideos,Mphotoes ,opt3 }  from './MovieSingleData';
...
export default function MovieSingle() {
    ...
    <>
        ...
        <div className='bg-[#020d18]'>
            <section className='MSinglebgTop relative w-full h-[598px] M-single-sec1'>
                <div className='container M-single-div w-full '>
                    <div className='row'>
                ...
                <div className='md:flex md:mx-[100px] mx-2 '>
                    <div className='md:w-[32%] w-full items-center justify-center'>
                        <div className='w-full h-[500px] px-6 md:sticky top-0'>
                            <img className='object-cover w-full h-[300px] lg:h-full shrink-0' src="./photoes/movie-single.jpg" alt="" />
                            <div className='w-full p-[18px] border-4 border-[#0c1c2c]'>
                                
                                <button className='w-full Fredoka1 font-bold flex itmes-center justify-center py-3 bg-[#dd003f] rounded-md mb-2 '><a className='flex items-center  justify-center text-white gap-2 rounded-lg' href=""> <FaPlay/>WATCH TRAILER</a></button>
                                <button className='w-full Fredoka1 font-bold py-3 rounded-lg bg-[#dcf836]'><a className='flex items-center  justify-center  gap-2 rounded-lg' href=""> <IoCardSharp/>BUY TICKET</a></button>
                            </div>
                        </div>
                    </div>

                    <div className='md:w-[68%] w-full px-6 pl-[12px]'>
                        <div className='pl-[10px] flex items-end gap-3 mb-8'> <h1 className=' Fredoka text-white font-black text-4xl '>Skyfall: Quantum of Spectre</h1> <span className='Fredoka1 text-2xl text-gray-400'>2015</span> </div>
                        ...
                        <div className='container'>
                            <div className='bloc_tabs flex flex-wrap  md:gap-12 gap-6 text-white Fredoka md:text-xl  font-bold mb-2 box-border'>
                                ...
                                <div onClick={()=>toggleTab(5)}  className={toggleState === 5 ? 'tabs active-tabs' : 'tabs'}>REATED MOVIES</div>
                            </div>
                                 ...
                                 <div className=" Overview md:flex">
                                    <div className='md:w-[70%] w-full  mr-3'>
                                        ...
                                        <div className='flex flex-wrap gap-8 mb-10'>
                                            <img className='rounded-lg' src="./photoes/image1.jpg" alt="" />
                                            <img className='rounded-lg' src="./photoes/image2.jpg" alt="" />
                                            <img className='rounded-lg' src="./photoes/image3.jpg" alt="" />
                                  ...
                                  {ReviewList.map((Ritem)=>(
                                   ...
                                   <div className='md:flex border-y border-gray-400 items-center justify-center w-full shrink-1 '>
                                        <p className='text-gray-400 text-sm md:mr-[100px] mr-0 py-2'>Reviews per page:</p>
                                         <select className='text-gray-300 text-xs  bg-transparent pr-24 md:border-x border-gray-400 py-2 font-bold   outline-none'  name="" id="">
                                                {opt1.map((itemm)=>(
                                ...
                                <div className={toggleState === 5 ? 'content active-content' : 'content'}>
                                   ...
                                   <p className='Fredoka1 text-gray-400 font-bold text-xl mb-6 '>Related Movies To</p>
                                     ...
                                     <div className='w-full border-y border-gray-500  flex  sm:flex-row flex-col items-center justify-center md:justify-start md:items-start   mb-8'>
                                        ...
                                        <select className='bg-transparent text-white text-sm py-2 md:border-l border-gray-500  outline-none hover:ountline-none active:outline-none visited:outline-none px-5' name="" id="">
                                        {optn.map((item)=>(
